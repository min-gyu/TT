			...
			<div class="row">
				<div class="col-lg-8 posts-list">
					<div class="single-post row">
						...
						<div class="col-lg-12">
							<!--  <div class="category" style="font-size:30px;padding-botton:10px;padding-top: 20px;">
								<a href="#" style="font-family: 'Merriweather', sans-serif;">VOD</a>
							</div>  -->
							<!-- <div class="button-group-area mt-40" style="padding-botton:10px;padding-top: 20px;">
								<a href="#" class="genric-btn info circle arrow">Info<span
									class="lnr lnr-arrow-right"></span></a>
							</div> -->
							<div class="info"
								style="padding-top: 20px; padding-bottom: 20px;">
								<a href="#" class="genric-btn info circle arrow">VOD<span
									class="lnr lnr-arrow-right"></span></a>
							</div>
						...
						<div class="col-lg-9 col-md-9">
							...
							<div class="col-lg-12">
								<div class="info"
									...
									<a href="#" class="genric-btn info circle arrow">게시글<span
										class="lnr lnr-arrow-right"></span></a>
								</div>
