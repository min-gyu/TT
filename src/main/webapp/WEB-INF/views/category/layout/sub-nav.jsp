...
<nav class="navbar navbar-expand-lg navbar-light  border-bottom">
	<div class="subscribe-nav">
		<a data-target="#live" 		href="javascript:void(0);">전체</a>
		<a data-target="#vod" 		href="javascript:void(0);">UAE아시안컵</a>
		<a data-target="#channel" 	href="javascript:void(0);">Menu3</a>
		<a data-target="#channel" 	href="javascript:void(0);">Menu4</a>
