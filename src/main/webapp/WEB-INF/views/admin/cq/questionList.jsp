...
$(function(){
	$("#listArea td").mouseenter(function(){
		...
		location.href="<%=request.getContextPath()%>/questionOne.ad?no=" + no;
	});
});
</script>
	...
	<div class="container">
		<div class="row" >
			...
			<div class="ui tabular menu">
				<a href="/claimList.ad" class="item" >신고 관리</a>
			  	<a href="/questionList.ad" class="active item" >문의 관리</a>
			</div>
			...
			<div class="center-block">
				<ul class="pagination mx-auto" style="justify-content: center;">
					...
					<c:if test="${ pi.currentPage > 1 }">
						<c:url var="listBack" value="/questionList.ad">
					...
					<c:forEach var="p" begin="${ pi.startPage }" end="${ pi.endPage }">
						...
						<c:if test="${ p ne pi.currentPage }">
							<c:url var="listCheck" value="/questionList.ad">
					...
					<c:if test="${ pi.currentPage < pi.maxPage }">
						<c:url var="listEnd" value="/questionList.ad">
							<c:param name="currentPage" value="${ pi.currentPage + 1 }" />
						</c:url>
						<li class="page-item">
